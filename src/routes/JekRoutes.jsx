...
import MeningMurojatlarim from "../pages/JEK/MeningMurojatlarim";
...
const JekRoutes = [
    ...
    {
        name: "mening-murojatlarim",
        path: 'mening-murojatlarim',
        element: <MeningMurojatlarim />
    },
    {
        name: "account",
        path: 'Account',
