...
export default function Inspectionlar() {
    ...
    const onlyINS = hodim.filter((h) => h.role === 'INSPECTION')
            ...
            <Flex direction="column" gap={3}>
                {loading ? (
                    ...
                    onlyINS.length > 0 ?
                        ...
                        }) : (form.ism.trim() || form.familiya.trim() || onlyINS.phoneNumber !== form.number || onlyINS?.addresses?.[0].address?.district !== form.tuman || onlyINS?.addresses?.[0].address?.neighborhood !== form.mahalla
