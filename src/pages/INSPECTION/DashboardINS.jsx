...
export default function Dashboard() {
  ...
  const [selectedTumanIdx, setSelectedTumanIdx] = useState("");
  ...
  const selectedTuman =
    selectedTumanIdx === "" || !Array.isArray(tumans)
      ? ""
      : tumans[Number(selectedTumanIdx)];

  // ✅ Yangilangan cardShell - gradient, shadow, hover bilan
 const cardShell = {
  bg: c.surface,
